...
function lister()
{
    ...
    $requete="select * from produit,categorie where categorie.cat_code=produit.pdt_categorie";
...
function supprimerUtilisateur($id, &$tabErr)
{
    $connexion = connecterServeurBD();
  ...
  function listerClient()
{
    ...
    $requete="select * from utilisateur where cat = 'client'";
    echo $requete; 
    ...
    {
        $fleur[$i]['id']=$ligne['id'];
        $fleur[$i]['nom']=$ligne['nom'];
        $fleur[$i]['mdp']=$ligne['mdp'];
        $fleur[$i]['cat']=$ligne['cat'];
...
function listerAdministrateur()
{
    ...
    $requete="select * from utilisateur where cat = 'admin'";
    echo $requete; 
...
function rechercherId($id, &$tabErr)
{
    $connexion = connecterServeurBD();
    ...
    if ($i == 0)
    {
      $message = "Aucune client ne correspond à cette identifiant";
      ajouterErreur($tabErr, $message);
    }
...
function modifierClient($id, $nom, $mdp, $cat,&$tabErr)
{
  ...
  $connexion = connecterServeurBD();
    ...
    $requete= "UPDATE `baselafleur1`.`utilisateur` SET `nom` = '$nom',
    `mdp` = '$mdp',
    `cat` = '$cat' WHERE `utilisateur`.`id`='$id';";
    ...
    function rechercherClient($id)
{
    ...
    $requete="select * from utilisateur";
      $requete=$requete." where id='".$id."' and cat='client';";  
      echo $requete;                   
     ...
     function rechercherAdmin($id)
{
    ...
    $requete="select * from utilisateur";
      $requete=$requete." where id='".$id."' and cat='admin';";  
      echo $requete;                   
